...
var gameState = {
    ...
    create: function () {
        ...
        this.stateManipulator.registerMemorable(guy, PhaserReverse.Creators.SPRITE);
        this.debugger = new PhaserReverse.Debugger(game, this.stateManipulator, {toolbar: false});
